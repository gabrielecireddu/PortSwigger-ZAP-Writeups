...
*   [Parte 1: Server-Side Vulnerabilities](#parte-1-server-side-vulnerabilities)
    ...
    *   [8. File Upload Vulnerabilities](#8-file-upload-vulnerabilities)
        *   [8.1 Bypass del Content-Type](#81-bypass-del-content-type)
        *   [8.2 Path Traversal nel Filename](#82-path-traversal-nel-filename)
        *   [8.3 Blacklist Bypass e Server Config Override](#83-blacklist-bypass-e-server-config-override)
...
#### 8.2 Path Traversal nel Filename
...
#### 8.3 Blacklist Bypass e Server Config Override
...
#### 8.4 Offuscamento con Null Byte
...
#### 8.5 Polyglot Files (Flawed Content Validation)
